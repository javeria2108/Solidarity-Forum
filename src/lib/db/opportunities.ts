...
// import { OpportunityCategory, OpportunityType, UrgencyLevel, OpportunityStatus } from '@prisma/client';
...
//   return opportunities.map((opportunity: { id: any; title: any; description: any; category: any; type: any; urgency: any; skillsNeeded: any; timeCommitment: any; location: any; isRemote: any; organization: { organizationName: any; profile: { avatar: any; }; }; _count: { applications: any; }; createdAt: any; maxVolunteers: any; }) => ({
//     id: opportunity.id,
...
// export async function createOpportunity(organizationId: string, data: {
//   title: string;
//   description: string;
