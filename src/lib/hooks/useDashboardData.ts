...
// import { OpportunityCategory, OpportunityType, UrgencyLevel } from '@prisma/client';
...
//         const response = await fetch(`/api/dashboard/opportunities?${queryParams}`, {
//           headers: {
...
//       try {
//         setLoading(true);
//         const response = await fetch('/api/dashboard/organization/opportunities', {
//           headers: {
//             'Authorization': `Bearer ${session.access_token}`
//           }
//         });
...
//       try {
//         setLoading(true);
//         const response = await fetch('/api/dashboard/organization/applications', {
//           headers: {
//             'Authorization': `Bearer ${session.access_token}`
//           }
//         });
...
//   const applyToOpportunity = async (opportunityId: string, coverLetter?: string) => {
